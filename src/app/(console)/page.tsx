...
export default function DashboardPage() {
  ...
  return (
    <>
      <PageHeader
        title="Dashboard"
        subtitle="Consolidated internal performance across all portfolios"
      >
        <Badge tone="up">
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <CardHeader
            title="Equity Curve"
            subtitle="Last 30 days · USDT"
            action={<Delta value={pnl30dPct} />}
          />
          <div className="p-4">
            ...
            {trades.slice(0, 5).map((t) => {
              ...
              return (
                <div key={t.id} className="flex items-center justify-between px-5 py-3">
                  <div>
                    <p className="text-sm font-medium text-text">{t.pair}</p>
